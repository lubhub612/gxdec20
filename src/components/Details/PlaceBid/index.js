...
import { SITE_NAME, TOKEN_SYMBOL } from '../../../config';
...
export const PlaceBid = (props) => {
  ...
  const tokenOptions = [
    ...
    { id: 2, value: '{TOKEN_SYMBOL}', content: <Option><img src={theme.images.chainTokenIcon} alt='' /><span>{TOKEN_SYMBOL}</span></Option> }
  ]
  ...
  return (
    <TimeAuctionContainer>
      ...
      <TermsOf>
        <CheckBox
          id='term'
          label={'By checking this box, I agree to GX’s Terms of service'}
